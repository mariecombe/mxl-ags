...
./Article2_methods_figures.py
    ...
    if (figure_2==False and figure_3==False and figure_4a==False and figure_4b==False and figure_5a==False and figure_5b==False): 
        print "\nYou didn't ask to plot any figure! Open the script and change that.\n"
    else: 
        print '\nFig 2 = %s,    Fig 3 = %s,    Fig 4a = %s,    Fig 4b = %s'%(figure_2,figure_3,figure_4a,figure_4b)
        print 'Fig 5a = %s,    Fig 5b = %s,    Fig 6a = %s,    Fig 6b = %s\n'%(figure_5a,figure_5b,figure_6a,figure_6b)
        print 'Fig 7a = %s,    Fig 7b = %s,    Fig 8 = %s,    Fig 9a = %s\n'%(figure_7a,figure_7b,figure_8,figure_9a)
        print 'Fig 9b = %s,    Fig 9c = %s\n'%(figure_9b,figure_9c)
    ...
    if (figure_4a == True): #if you want to plot figure 4a
        ...
        cs= pyplot.contour(X, Y, Z2, levels, colors='k', linewidths=0.5) 
    ...
    if (figure_5a == True): #if you want to plot figure 5a
        ...
        results_filename = '2DIM_SA_cc_0-30_gammatheta_2-8_SMI=0.8/Results_cc_ga.dat'
        ResDict = open_data(storagedir,[results_filename])
